...
func (b *Beat) createBeater(bt beat.Creator) (beat.Beater, error) {
	...
	pipeline, err := pipeline.Load(b.Info,
		...
		b.Config.Pipeline, // 配置
		b.processing,
		b.makeOutputFactory(b.Config.Output), // 根据用户配置，生成对应的output factory
	)
